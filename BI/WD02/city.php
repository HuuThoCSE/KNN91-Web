...
<body>
	<div>
		<img src="./City_files/banner.gif" alt="City Searcher">
	</div>
	<p>
	...
	<select name="countrycode" id="country">
		...
		if ($conn->connect_error) {
			...
			$data = $conn->query("select Name from countries");
			if ($data->num_rows > 0) {
	...
	<select name="count" id="top">
		<option value="3">top 3</option>
		<option value="5">top 5</option>
		<option value="10">top 10</option>
	</select>
	<button id="query">Query Submit</button>
	<script>
		document.getElementById('query').addEventListener('click', function () {
			window.location = "show.php?top=" + document.getElementById('top').value+"&country="+document.getElementById('country').value;
		});
	</script>
</body>
</html>